                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 store-item">
                            ...
                            <div class="store-text row">
                                <div class="form-group col-sm-12">
                                    ...
                                    <select name="group_host" class="form-control">
                                        <option value="0" selected>請選擇揪團負責人</option>
                                ...
                                <div class="form-group col-sm-6">
                                    <label>
                                        活動名稱<input type="text" value="{$item.name}" name="store_name" readonly
                                                   class="form-control">
                                    </label>
                                </div>
                                ...
                                <div class="form-group col-sm-6">
                                    <label>
                                        活動電話<input type="text" value="{$item.phone}" name="store_phone" readonly
                                                   class="form-control">
                                    </label>
                                </div>
                            ...
                            <div class="form-group mt-3 text-center">
                                <button class="btn btn-default" type="submit">確認資料，開始揪團</button>
                            </div>
                        </div>
