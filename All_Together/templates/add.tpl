                ...
                <div class="col-sm-12">
                    <form action="add.php" method="post" enctype="multipart/form-data" id="addStoreForm">
                        ...
                        <div class="">
                            ...
                            {/if}
                            <div class="row">
                                <label class="col-sm-2 col-form-label text-right">活動名稱</label>
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        <input type="text" name="name"
                                               class="form-control border-top-0 border-left-0 border-right-0 border-bottom"
                                               {if isset($name)}value="{$name}"{/if} placeholder="請輸入活動名稱 *">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <label class="col-sm-2 col-form-label text-right">聯絡人電話</label>
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        <input type="text" name="phone"
                                               class="form-control border-top-0 border-left-0 border-right-0 border-bottom"
                                               {if isset($phone)}value="{$phone}"{/if} placeholder="請輸入聯絡人電話">
                                    </div>
                                </div>
                            </div>

                            <div class="row">
                                <label class="col-sm-2 col-form-label text-right">活動介紹</label>
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        <textarea name="description" cols="30" rows="3" class="form-control"
                                                  placeholder="請輸入活動介紹">{if isset($description)} {$description} {/if}</textarea>
                                    </div>
                                </div>
                            </div>

                            <div class="row">
                                <label class="col-sm-2 col-form-label text-right">活動預計金額</label>
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        <input type="number" name="store_full_price"
                                               class="form-control border-top-0 border-left-0 border-right-0 border-bottom"
                                               {if isset($store_full_price)}value="{$store_full_price}"{/if}
                                               placeholder="滿多少錢才可成團，不限制請輸入 0">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group text-center mt-4">
                            <button type="submit" class="btn btn-default">新增活動</button>
                        </div>
