                    ...
                    <div class="col-sm-4 mb-3">
                        <div class="card">
                            <div class="store-image">
                                <a href="group-buy.php?id={$item.id}" title="發起{$item.name}的團">
                                    {if $item.store_cover !== ''}
                            ...
                            <div class="store-name text-center store-item store-text my-3 position-relative">
                                <a href="group-buy.php?id={$item.id}" title="發起{$item.name}的團" class="title">
