    ...
    <div class="header-top">
        <div class="container">
            <div class="d-flex justify-content-between">
                <a href="index.php" class="navbar-brand">All Together !<span></span></a>
                <nav class="header__account">
                    <ul class="d-flex header__nav-settings">
                        ...
                        <li class="link-item">
                            ...
                            <ul class="drop-menu">
                                <li class="link-item">
                                    <a href="add.php" title="新增活動">新增活動</a>
                                </li>
                                <li class="link-item">
                                    <a href="edit-res.php" title="編輯活動">編輯活動</a>
                                </li>
                                <li class="link-item">
                                    <a href="edit-group-buy.php" title="編輯揪團單">編輯揪團單</a>
                                </li>
                            </ul>
                        </li>
                        {/if}
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a href="group-buy-now.php" class="nav-link">
                            <span class="mr-1">進行中揪團</span> <span class="badge badge-light"
                                                                  id="group_now_badge">0</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="res-list.php" class="nav-link">活動列表</a>
                    </li>

                        <li class="nav-item">
                            <a href="group-history.php" class="nav-link">歷史揪團單</a>
                        </li>
